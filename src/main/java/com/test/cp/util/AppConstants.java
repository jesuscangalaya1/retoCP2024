...
public class AppConstants {
    ...
    public static final String BAD_REQUEST_ORDER = "Pedido no encontrado con el ID: ";
    public static final String BAD_REQUEST_PRODUCT_NAME = "No se encontraron productos con el nombre proporcionado: ";
    ...
    public static final String MESSAGE_ID_ORDER = "PEDIDO ID: ";
    ...
    public static final String ORDENAR_POR_DEFECTO_ORDER = "orderId";
