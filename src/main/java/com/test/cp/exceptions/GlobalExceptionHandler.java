package com.test.cp.exceptions;

import com.test.cp.dto.response.DataErrorValidation;
import com.test.cp.dto.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> tratarError400(MethodArgumentNotValidException e){
        var errores = e.getFieldErrors().stream().map(DataErrorValidation::new).collect(Collectors.toList());
